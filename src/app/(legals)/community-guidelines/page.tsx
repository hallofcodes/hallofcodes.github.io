  ...
  return (
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <p className="mt-2 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
        We’re glad you’re here. To ensure Hall of Codes remains a welcoming and
        safe place for everyone, please follow these guidelines:
      </p>
      ...
      <div className="mt-10 space-y-6">
        <div>
          ...
          <p className="text-gray-500">
            Treat all members with respect. Harassment, hate speech, or personal
