    ...
    <main className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 mb-9">
          ...
          collaboration among developers worldwide. Discover our journey,
          mission, and commitment to advancing coding knowledge and skills in an
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mt-2 w-full max-w-2xl mx-auto">
            ...
            innovate, and excel in their coding endeavors, fostering a culture
